...
class MonitorModule(ExtendedModule):
    ...
    def render(self) -> None:
        ...
        with ui.column().classes("w-full gap-2"):
            ...
            online_count = sum(
                1 for item in data if item["extra"]["status"] == "online"
            )
    ...
    def render_detail(self) -> None:
        ...
        with ui.column().classes("w-full gap-6 max-w-4xl mx-auto"):
            ...
            offline_count = sum(
                1 for item in data if item["extra"]["status"] == "offline"
            )
                ...
                for item in data:
                    ...
                    with (
                        ...
                        with ui.row().classes("gap-2"):
                            ui.button(
                                "Open",
                                on_click=lambda e, url=extra["url"]: ui.navigate.to(
                                    url
                                ),
                            ).classes(
