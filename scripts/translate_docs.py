...
translations = {
    "Research Dashboard 文档": "Research Dashboard Documentation",
    "欢迎阅读 Research Dashboard 文档。本指南将帮助您了解如何安装、配置和使用 Research Dashboard 应用程序。": "Welcome to the Research Dashboard documentation. This guide will help you understand how to install, configure, and use the Research Dashboard application.",
    ...
    "贡献": "Contributing",
    "关于 Research Dashboard": "About Research Dashboard",
    "Research Dashboard 是一个为研究人员设计的可定制信息聚合仪表盘。它提供了一个统一的界面来查看和管理来自多个来源的信息，包括：": "Research Dashboard is a customizable information aggregation dashboard designed for researchers. It provides a unified interface to view and manage information from multiple sources including:",
    "基于您研究兴趣的 ArXiv 论文": "ArXiv papers based on your research interests",
    ...
    "获取帮助": "Getting Help",
    "如果您需要 Research Dashboard 方面的帮助，您可以：": "If you need help with Research Dashboard, you can:",
    "查看本指南中的文档": "Check the documentation in this guide",
    "在 [GitHub 仓库](https://github.com/WayneXuCN/ResearchDashboard) 上报告问题": "Report issues on the [GitHub repository](https://github.com/WayneXuCN/ResearchDashboard)",
...
def main():
    ...
    docs_dir = '/Volumes/Work/DevSpace/01_APP/ResearchDashboard/docs'
